...
<link rel="stylesheet" type="text/css" href="../scriptAll/jquery-ui.css">
<script async
...
<script type="text/javascript"
   src="../scriptAll/jquery.ui.datepicker-ko.js"></script>
<script type="text/javascript" src="../scriptAll/jquery.blockUI.js"
   charset="utf-8"></script>
<script type="text/javascript"
   src="../scriptAll/jquery.inputmask.bundle.min.js" charset="utf-8"></script>
<script type="text/javascript" src="../scriptAll/jquery.number.min.js"
   charset="utf-8"></script>
...
<div class="wrap" id="wrap">
   <main class="container page logmain" id="container">
      ...
      <div class="inr" style="min-height: 1092px;">
            ...
            <section class="logContentBox">
               <div class="lcbPicture sw">
                  ...
                  <div class="swiper-container logMain swiper-container-initialized swiper-container-horizontal">
                     ...
                     <div class="remote-area">
                        <button class="swiper-button-next" type="button" tabindex="0"
                           role="button" aria-label="Next slide" aria-disabled="false"></button>
                        <button class="swiper-button-prev" type="button" tabindex="0"
               ...
               <div class="lcbWebRconBox">
                  ...
                  <div class="lcbConTxt">
                     ...
                     <div class="userInfo">
                        <div class="pic">
                           <img src="${ dto.pet_img }" alt="#">
                        </div>
                        <!--  pic 프로필사진  -->
                        <div class="con">
                           <div class="txt">
                              <a class="nickname"
                                 href="/AboutPet/Project/aboutPet/myPetlog.do?mem_code=${ dto.mem_code }">${ dto.nickname }</a>
                              <span class="dotIcon2x2 onWeb_ib"></span> <span class="time">${ dto.log_date }</span>
                           </div>
                        </div>
                        <!-- txt 닉네임 , 날짜 -->

                        <div class="menu dopMenuIcon"
                           onclick="ui.popSel.open(this,event)">
                           <div class="popSelect r">
                              <input type="text" class="popSelInput">
                              <div class="popSelInnerWrap" style="height: 0px;">
                                 <ul>
                                    <li><a class="bt"
                                       href="javascript:layerPetLogReport('7171','', '','N');" id="btRptp_7171"><b class="t">신고</b></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                        ...
                        <ul class="bar-btn-area">
                           <li id="likeBtn1_3934">
                              <button class="logBtnBasic btn-like"
                                 id="like_${dto.log_code}"
                                 onclick="savePetLogInterest('${dto.log_code}', '10', 'I', '')">${dto.log_like}</button>
                           </li>
                           <li>
                              <button class="logBtnBasic btn-comment"
                                 onclick="viewReply('${dto.log_code}','', this);">${dto.log_cmt}</button>
                           </li>
                           <li>
                              <button class="logBtnBasic btn-share"
                                 data-message="링크가 복사되었어요" data-title="${ dto.mem_name }"
                                 title="COPY URL"
                                 onclick="sharePetLog('${ dto.log_code}', this.id, 'P');"
                                 id="share1_3934"
                                 data-clipboard-text="localhost/AboutPet/Project/aboutPet/detailpetlog.do?log_code=${ dto.log_code}">
                                 <span>공유</span>
                              </button>
                           </li>
                           <li class="ml20" id="bookBtn1_3934">
                              <button class="logBtnBasic btn-bookmark"
                                 id="mark_${dto.log_code}"
                                 onclick="savePetLogInterest('${dto.log_code}', '20', 'I', '')">
                                 <span>북마크</span>
                              </button>
                           </li>
                        </ul>
                  ...
                  <!-- 댓글 클릭 창 -->
                  <div class="commentBoxAp logcommentBox pop1" id="cmt_${dto.log_code}" style="bottom: 0px; height: 90%;">

                     <div class="head t2">
                        <div class="con">
                            <div class="tit">댓글<span class="price-box">${dto.log_cmt}</span></div>
                     ...
                     <div class="con t2">
                        <div class="box inf">
                           <div class="commendListBox">
                              ...
                              <c:choose>
                                 <c:when test="${ dto.log_cmt ne 0 }">
                                    <c:forEach items="${ cmtlist }" var="cl">
                                       <ul>
                                          <li>
                                             <div class="pic"
                                                onclick="javascript:goMyPetLog('','${ cl.mem_code }',event);">
                                                <img src="${ cl.pet_img }" alt="img">
                                             </div>
                                             <div class="con">
                                                <div class="tit">${ cl.mem_name }</div>
                                             ...
                                             <div class="menu dopMenuIcon"
                                                ...
                                                <div class="popSelect">
                                                   ...
                                                   <div class="popSelInnerWrap">
                                                      <ul>
                                                         <li><a class="bt"
                                                            href="javascript:layerPetLogReport('${ cl.log_code }','770', '');"><b
                                                               class="t">신고</b></a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                        ...
                        <div class="input">
                           ...
                           <textarea onclick="checkReplyInput();"
                              placeholder="댓글을 입력해주세요." id="reply_123" name="reply"
                              tabindex="-1"></textarea>
                           <div class="btn_wrap">
                              <button class="del" style="display: none;">close</button>
                              <button id="regBtn_8554" name="regBtn"
                                 onclick="savePetLogReply('8554', '', '')" class="ac">등록</button>
                           </div>
                        </div>
                        <div class="fixed_box">
                           ...
                           <div class="alert-commentBox" id="uptCmtDisp_123"
                              style="display: none;">
                              <p>
                                 <span class="icon-speechBubble"></span>댓글을 수정 중입니다.
                              </p>
		...
		<!-- 신고 -->
		<article class="popLayer a popSample1 pc_popSize_500 on" id="popReport"
		   ...
		   <div class="pbd">
		      <div class="phd">
		         <div class="in">
		            ...
		            <button type="button" class="btnPopClose"
		               onclick="$('#commitBtn').addClass('disabled')">닫기</button>
		      ...
		      <div class="pct" style="height: 661.6px;">
		         <main class="poptents report">
		            <form id="petLogRptpForm" name="petLogRptpForm" method="post"
		               onsubmit="return false;">
		               <input type="hidden" name="petLogAplySeq" value="">
		               <!-- 댓글 순번 -->
		               <input type="hidden" name="petLogNo" value="8538">
		               <!-- 펫로그번호 -->
		               <input type="hidden" name="mbrNo" value="950350">
		               <!-- 회원번호       -->
		               <input type="hidden" name="listNo" value="">
		               <!-- 회원번호       -->
		               <input type="hidden" name="rvwYn" value="Y">
		               <!-- 리뷰여부    -->
		               <div class="lay-gray-box">
				                  신고접수 시 운영정책에 따라 검토 후 해당글이 삭제됩니다.<br> 신고 관련된 자세한 사항은 고객센터로
				                  연락주세요.
		               </div>
		               ...
		               <div class="textarea m">
		                  <textarea name="rptpContent" placeholder="신고사유를 입력해주세요." style="height: 260px;"></textarea>
		               </div>
		               <div class="log_btnWrap">
		                  <button class="btn lg onWeb_if"
		                     onclick="ui.popLayer.close('popReport');$('#commitBtn').addClass('disabled')">취소</button>
		                  <button class="btn a lg disabled"
		                     onclick="insertPetLogRptp('popReport');" id="commitBtn">완료</button>
		               </div>
		            </form>
		         </main>
		      </div>
...
<script>
   ...
   function goMyPetLog(petLogUrl, mbrNo, event , insertYn){
      ...
      } // /jspPro/aboutPet/log/myPetlog.do?mem_code=${ list.mem_code }
