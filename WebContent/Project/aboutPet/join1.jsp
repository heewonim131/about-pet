                ...
                <div class="fake-pop">
                    <div class="pct">
                        <div class="poptents">
                            <form id="join_form" action="/AboutPet/Project/aboutPet/sign_up.do" method="post">
                                ...
                                <input type="hidden" id="termsNo" name="termsNo"
                                       value="[{termsNo:1,rcvYn:Y},{termsNo:94,rcvYn:Y},{termsNo:90,rcvYn:Y},{termsNo:93,rcvYn:Y},{termsNo:5,rcvYn:N},{termsNo:9,rcvYn:N}]">
                                ...
                                <div class="member-input">
                                    <ul class="list">
                                        ...
                                        <li style="display:none;">
                                            ...
                                            <div class="input del">
                                                <input type="text" class="cleanValMsg" id="join_mbr_nm" name="mbrNm"
                                                       value="" maxlength="10" placeholder="이름을 입력해주세요.">
                                            </div>
                                        ...
                                        <li style="display:none;">
                                            ...
                                            <div class="input del">
                                                <input type="number" class="cleanValMsg" id="join_mobile" name="mobile"
                                                       title="휴대폰번호" value="" maxlength="20"
                                        ...
                                        <li style="display:none;">
                                            ...
                                            <div id="join_birth_not_accept" class="input del">
                                                <input type="number" class="cleanValMsg" id="join_birth" name="birth"
                                                       value="" maxlength="8" placeholder="숫자 8자리 입력(예:20210101)">
                                            </div>
                                        ...
                                        <li style="display:none;">
                                            ...
                                            <div class="flex-wrap">
                                                <label class="radio"><input type="radio" id="join_gd_gb_cd2"
                                                                            name="gdGbCd" value="10"><span class="txt">남자</span></label>
                                                <label class="radio"><input type="radio" id="join_gd_gb_cd1"
                                                                            name="gdGbCd" value="20"><span class="txt">여자</span></label>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="input del">
                                                <input type="text" id="join_nickname" name="nickNm"
                                                       class="required_join_input cleanValMsg"
                                                       placeholder="닉네임을 입력해주세요." maxlength="20" value="">
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="input">
                                                <input type="text" class="cleanValMsg" id="join_rcomId"
                                                       name="rcomLoginId" placeholder="추천인 정보를 입력해주세요.">
                                            </div>
                    ...
                    <div class="pbt pull">
                        <div class="bts" id="inactiveBtn">
                            <a href="javascript:;" id="nextBtn" class="btn lg gray" data-content="" data-url="">다음</a>
                            <!--pointer-events: none;  -->
                        </div>
                        <div class="bts" id="activeBtn" style="display:none;">
                            <a href="javascript:insertMember();" id="nextBtn" class="btn lg a" data-content=""
                               data-url="">다음</a><!--pointer-events: none;  -->
                        </div>
                    </div>
