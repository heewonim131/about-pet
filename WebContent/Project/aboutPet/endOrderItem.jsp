				...
				<div class="contents" id="contents">
					<div class="ordersets">
						<section class="topbox">
							<div class="hdd">
								<div class="hd">
									<em class="nm">${ordNm }</em>님 <br>주문이 완료되었습니다.
								</div>
						...
						<section class="sect addr">
							...
							<div class="cdts">
								<div class="adrset">
									<div class="name">
										<em class="t">${adr_name }</em>
									</div>
									<div class="adrs">
										${adr_detail }</div>
									<div class="tels">${orNm } | ${contact }</div>
								</div>
								<div class="adrreq">
									<div class="pwf">
										<em class="t">
										...
										<div class="txt custom_ellipsis_dlvr"></div>
									</div>
								</div>
							</div>
						</section>
							...
							<div class="cdts">
								<ul class="prcset">
									<li>
										...
										<div class="dd">
											<span class="prc"><em class="p">${pTotalPay }</em><i class="w">원</i></span>
										</div>
									</li>
									<li>
										<div class="dt">배송비</div>
										<div class="dd">
											<span class="prc"><em class="p">0</em><i class="w">원</i></span>
										</div>
									</li>
								</ul>
								<div class="tot">
								...
								<div class="gdpnt">구매확정 후 GS&amp;POINT <em class="p"><fmt:formatNumber pattern="#,###"
											value="${ dto.item_price * s_price*0.001  }"></fmt:formatNumber>P 적립</em></div>
							</div>
						</section>
						<section class="sect binf">
								...
								<div class="cdts">
									<div class="result">
										<div class="hd">
											<em class="b">일반결제</em>
												<i class="t">${PayMethod }</i>
												</div>
										<div class="dd">**카드/일시불</div>
											</div>
								</div>
							</section>
