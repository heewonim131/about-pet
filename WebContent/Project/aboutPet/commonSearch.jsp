...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            <%String searchWord=request.getParameter("srchWord");%>

            var lastUrl = window.location.href;

            if (lastUrl.indexOf("srchWord") != -1) {
                $.ajax({
                    type: "get",
                    url: "/AboutPet/Project/aboutPet/searchResult.do?srchWord=<%=searchWord%>"
                    //,data:searchWordData
                    , dataType: "html"
                    , success: function (html) {
                        $("body").html(html);
                        $("#srchWord").attr("value", "<%=searchWord%>");
                        $("#srchWord").blur();
                    },
...
<script>
    ...
    $(function(){
      ...
      /*    $.ajax({
            type:"get",
            url: "/AboutPet/Project/aboutPet/topList.do"
            //,data:searchWordData
            ,dataType : "html"
           , success: function(html){
                $("body").html(html);
...
<%--  <%boolean searchMain=true; 
 //String searchWord=(String)request.getAttribute("srchWord");
if(request.getAttribute("srchWord").equals(null)){
	 searchMain=true; 
}else{
	 searchMain=false;
}
%>
 <c:set var="main" value="<%=searchMain%>"></c:set> 
<c:if test='${ main eq true }'>
<c:import url="header.jsp" />트루  
</c:if>
<c:if test='${ main ne true }'>
<c:import url="loginheader.jsp" />펄스 
</c:if> --%>
                        ...
                        <div class="swiper-container t01">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <ul class="item">
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(0).getS_word() }"
                                        ...
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(1).getS_word() }"
                                               data-content="" data-url="/commonSearch">
                                        ...
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(2).getS_word() }"
                                               data-content="" data-url="/commonSearch">
                                        ...
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(3).getS_word() }"
                                               data-content="" data-url="/commonSearch">
                                        ...
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(4).getS_word() }"
                                               data-content="" data-url="/commonSearch">
                                ...
                                <div class="swiper-slide">
                                    <ul class="item">
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(5).getS_word() }"
                                               data-content="" data-url="/commonSearch">
                                        ...
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(6).getS_word() }"
                                               data-content="" data-url="/commonSearch">
                                        ...
                                        <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(7).getS_word() }"
                                               data-content="" data-url="/commonSearch">
                                                <span class="num">8</span>
                                                <p class="txt"><%=topList.get(7).getS_word() %>
                                                </p>
                                                <span class="ranking "><%=Math.abs(topList.get(7).getChangedRank())%></span>
                                            </a>
                                        </li>
                                        <%--
                                    <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(8).getS_word() }" data-content="" data-url="/commonSearch">
                                                <span class="num">9</span>
                                                <p class="txt"><%=topList.get(8).getS_word() %></p>
                                                <span class="ranking "><%=Math.abs(topList.get(8).getChangedRank())%></span>
                                                    </a>
                                        </li>
                                    <li>
                                            <a href="commonSearch.do?srchWord=${topList.get(9).getS_word() }" data-content="" data-url="/commonSearch">
                                                <span class="num">10</span>
                                                <p class="txt"><%=topList.get(9).getS_word() %></p>
                                                <span class="ranking "><%=Math.abs(topList.get(9).getChangedRank())%></span>
                                                    </a>
                                        </li>
                                         --%>
                                    </ul>
