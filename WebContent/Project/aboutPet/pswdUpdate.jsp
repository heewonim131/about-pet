		...
		<div class="myCate">
			<ul class="menu">
				...
				<li class="open">
					...
					<ul class="sm">
						<li class="active"><a class="bt" href="pswdUpdate.jsp" data-url="pswdUpdate.jsp" data-content="954216"><b class="t">비밀번호 설정</b></a></li>
		...
		<script type="text/javascript">
			...
			function checkMemberPassword(){
		        ...
		        $.ajax({
		        	type: 'POST',
		        	url: "manageCheck.do",
		        	data: {pwd : $("#manage_chk_pswd").val()},
		        	dataType: 'html',
		        	success: function(){
		        		location.href = "manageDetail.do";
		        	},
		        	error: function(){
						$("#errorMsg").text("비밀번호를 다시 확인해주세요.").show();
		        	}
...
// 					url = "indexMyInfo?returnUrl=/mypage/indexMyPage"; 
					url = "indexMyInfo"; 
				}else{
					url = returnUrl;
				}
...
// 					$("#footer").remove();
 ...
 <main class="container page login srch" id="container">
			...
			<div style="display:none;">
				<input type="hidden" id="RSAModulus" value="">
			...
			<div class="inr" style="min-height: 417px;">
				<!-- 본문 -->
					...
					<div class="fake-pop">
						...
						<div class="pbt mt30">
							<div class="btnSet" id="confirmBtn">
								<a href="javascript:checkMemberPassword();" class="btn lg a gray" data-url="/mypage/info/checkMemberPassword" data-content="954216" disabled="">확인</a>
							</div>
						</div>
					</div>
				</div>
