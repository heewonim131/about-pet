...
<script type="text/javascript" 	src="https://vknfvtjnsgec6381690.cdn.ntruss.com/js/kakao-map.js"></script>
<!-- app interface --> 
...
<!-- 기본 컨텐츠 -->
	...
	function setCartCnt(){
		$.ajax({
			url : "/AboutPet/Project/aboutPet/cartCnt.do"
			, dataType : "json"
			, type : "POST"
			, success : function(data){
				...
				if($cartCntObj.length == 0){
					if(item[0].carCnt != 0){
						var html = '<em class="n">'+item[0].carCnt+'</em>';
...
String grade=null;
if(memberDTO.getGr_name()!=null){
	 grade=memberDTO.getGr_name();	 
}else{
	grade="1";
}
switch(grade){
...
<!-- -->
				<h1 class="logo shop">
					<a class="bt" href="/AboutPet/Project/aboutPet/shop_home.do">AboutPet</a>
				</h1>
				<nav class="menushop">
 ...
 // mobile -->
			...
			<div class="cdt">
						...
						<div class="menu">
							...
							<button class="bt cart" type="button" onclick="location.href='cartList.do'">
									</button>
...
} else if(lastUrl.indexOf("tv_main.do") != -1){
...
<article class="popLayer a popLank on" id="popLank" tabindex="0" style="display: none;">
				<div class="pbd">
					<div class="phd">
						<div class="in">
							<h1 class="tit"></h1>
					...
					<div class="pct" style="height: 661.6px;">
						<main class="poptents">
							<div class="rankCont">
								<div class="rank_imgBox rank_pc on">
											<img src="https://aboutpet.co.kr/_images/common/img-level-pc.png" alt="어바웃펫 패미리 등급별 혜택 이미지">
										</div>
									</div>
						</main>
					</div>
