               ...
               <!-- user content -->
                     <div class="lcbConTxt">
                        ...
                        <div class="userInfo"> 
                           ...
                           <div class="con">
                              <div class="txt">
                                <a class="nickname" href="/AboutPet/Project/aboutPet/myPetlog.do?mem_code=${ list.mem_code }&log_code=${list.log_code}">${ list.nickname }</a> 
                     ...
                     <div class="lcbmenuBar" id="adminHideArea2">
                        <div class="inner">
                           <ul class="bar-btn-area">
                              <li id="likeBtn1_3934" >
                                 <button class="logBtnBasic btn-like" id="like_${list.log_code}"
                              ...
                              <li class="ml20" id="bookBtn1_3934">
                                 <button class="logBtnBasic btn-bookmark" id="mark_${list.log_code}"
...
<script>
    ...
    $(document).ready(function (){
        // 로그인한 회원 
        var mem = document.getElementById("test").className;
        var code = document.getElementById("first_log_code").innerText;
        var petLogNol = document.getElementById("like_"+code);   
        //console.log(mem);
        //console.log(code);
