								...
								<div class="box">
									<div class="cate slideShop">
										<div class="swiper-container">
											<ul class="swiper-wrapper slide">
												<li class="swiper-slide active"><a
													data-ui-tab-btn="tab_my_cate"
													data-ui-tab-val="tab_my_cate_1" href="javascript:;"
													class="bt">내 활동</a></li>
												<li class="swiper-slide"><a
													data-ui-tab-btn="tab_my_cate"
										...
										<ul class="sm">
											<li><a class="bt" href="/my/pet/myPetListView"
												data-content="951865" data-url="/my/pet/myPetListView">마이펫
													관리</a></li>
											<li><a class="bt" href="/mypage/tv/myWishList">마이
													찜리스트</a></li>
									...
									<div class="ctset ctset2" data-ui-tab-ctn="tab_my_cate"
										...
										<ul class="sm">
											...
											<li><a class="bt" href="/customer/inquiry/inquiryView"
												...
												data-content="951865">1:1 문의</a></li>
											<li><a class="bt" href="/mypage/order/indexClaimList"
												data-url="/mypage/order/indexClaimList"
												data-content="951865">취소/반품/교환</a></li>
											...
											<li><a class="bt" href="/mypage/info/coupon"
												data-url="/mypage/info/coupon" data-content="951865">내
													쿠폰</a></li>
											<li><a class="bt"
									...
									<div class="ctset ctset3" data-ui-tab-ctn="tab_my_cate"
										...
										<ul class="sm">
											<li><a class="bt" href="/mypage/info/indexPswdUpdate"
												data-content="951865"
												data-url="/mypage/info/indexPswdUpdate">비밀번호 설정</a></li>
											<li><a class="bt" href="/mypage/info/indexManageCheck"
												data-content="951865"
												data-url="/mypage/info/indexManageCheck">회원정보 수정</a></li>
										</ul>
									</div>
								</div></li>
						</ul>
...
.custom_ellipsis_dlvr {
	...
	overflow: hidden;
			...
			<div class="inr">
				...
				<form id="order_payment_form" name="order_payment_form" method="post">
					...
					<input type="hidden" id="order_payment_ord_no" name="ordNo"
						value="${ord_code+1 }"> <input type="hidden" id="mbrNo" name="mbrNo"
						value="${mem_code }"> <input type="hidden" id="gsptNo"
                  		name="gsptNo" value="${shopDTO.opt_code}"> <input type="hidden"
						id="ordNm" name="ordNm" value="${orderDTO.mem_name }"> <input type="hidden"
						id="ordrEmail" name="ordrEmail" value="${orderDTO.mem_email }">
					<input type="hidden" id="ordrTel" name="ordrTel"
						value="${orderDTO.contact }"> <input type="hidden" id="ordrMobile"
						name="ordrMobile" value="${orderDTO.contact }"> <input
						type="hidden" id="mbrDlvraNo" name="mbrDlvraNo" value="73379">
						<input type="hidden" name="adr_name"  id ="adr_name" value="${orderDTO.adr_name }"/>
						<input type="hidden" name="adr_detail"  id ="adr_detail" value="${orderDTO.adr_detail }"/>
						<input type="hidden" name="requests"  id ="requests" value="${orderDTO.requests }"/>	
						<input type="hidden" name="d_contact"  id ="d_contact" value="${orderDTO.d_contact }"/>
						<input type="hidden" name="totalPay"  id ="totalPay" value="${pTotalPrice}"/>
						<input type="hidden" name="adr_code"  id ="adr_code" value="${orderDTO.adr_code}"/>
						<input type="hidden" name="dr_enter"  id ="dr_enter" value="${orderDTO.dr_enter }"/>
						<input type="hidden" name="totalCnt"  id ="totalCnt" value="${pTotalCnt }"/>
						<input type="hidden" name="dr_loc"  id ="dr_loc" value="${orderDTO.dr_loc }"/>
					...
					<input type="hidden" name="SelectCardCode" id="selectCardCode"
						...
						id="goodsName" value="${shopDTO.opt_name }"> <input
						type="hidden" name="BuyerName" id="buyerName" value='${orderDTO.mem_name }'>
					<input type="hidden" name="BuyerEmail" id="buyerEmail"
						value=' ${orderDTO.mem_email }'> <input type="hidden"
						name="BuyerTel" id="buyerTel" value='${orderDTO.contact }'> 
					<!-- 옵션 -->

					<!-- 카드 옵션 -->
					<input type="hidden" name="SelectQuota" id="selectQuota" value="00" />
					<!-- 할부개월 제한 -->
					<input type="hidden" name="ShopInterest" id="shopInterest"
						value="0" />
				</form>
				...
				<div class="contents" id="contents">
					<div class="ordersets">
						...
						<section class="sect addr">
							...
							<div class="cdts">
								<div class="adrset">
									<input type="hidden" id="order_payment_gb_nm" value="집">
									<input type="hidden" id="order_payment_mbr_dlvra_no"
										value="73379"> <input type="hidden"
										id="order_payment_post_no_new" value="18527"> <input
										type="hidden" id="order_payment_road_addr"
										value="${orderDTO.adr_detail }"> <input
										type="hidden" id="order_payment_road_dtl_addr" value="302호">
									<input type="hidden" id="order_payment_adrs_nm" value="박호진">
									<input type="hidden" id="order_payment_adrs_mobile"
										value="01074567760"> <input type="hidden"
										id="order_payment_demand_goods_rcv_pst_cd" value="10">
									<input type="hidden"
										id="order_payment_demand_goods_rcv_pst_etc" value="">
									<input type="hidden"
										id="order_payment_demand_pbl_gate_ent_mtd_cd" value="10">
									<input type="hidden" id="order_payment_demand_pbl_gate_pswd"
										value="종 5725"> <input type="hidden"
										id="order_payment_dlvr_demand" value=""> <input
								...
								<div class="adrreq">
									...
									<div class="pwf" id="existDemand">
										<em class="t" id="demandGoodsRcvPstCd"> ${orderDTO.dr_loc }</em> <em class="p"
											id="demandPblGateEntMtdCd"> ${orderDTO.dr_enter }&nbsp; <if
												test="true"> ${orderDTO.requests }</if>
										</em>
										<div class="txt custom_ellipsis_dlvr" id="demandDlvrDemand"></div>
									</div>
								</div>
							</div>
							</c:if>
						...
						<section class="sect deli">
							...
							<div class="cdts">
									...
									<li><label class="radio"> <input type="radio"
											...
											<div class="txt iconArea icon_20">
												...
												<div class="cdd pd_tog_box" style="display: none;">
													<ul class="lst">
														<li>
															<div class="tt">${shopDTO.opt_name }</div>
															<div class="tt">${shopDTO.opt_name }</div>
															<div class="ts"> ${pTotalCnt }개 / ${shopDTO.item_price * pTotalCnt }원</div>
														</li>
													</ul>
												</div>
											</div>
								...
								<input type="hidden" name="order_payment_cart_ids"
									id="order_payment_cart_ids" value="950616037779017530"
									data-cart-id="950616037779017530" data-buy-qty="1"
									data-goods-nm="JW 홀리풋볼 M (색상랜덤)" data-goods-id="PI000003557"
									data-dlvrc-plc-no="1" data-sel-mbr-cp-no=""
									data-sale-prc="6500" data-comp-gb-cd="10" /> <input
									type="hidden" name="order_payment_pkg_dlvr_nos"
									id="order_payment_pkg_dlvr_nos" value="1" /> <input
									type="hidden" name="order_payment_pkg_dlvr_amts"
									id="order_payment_pkg_dlvr_amts" value="2500" /> <input
									type="hidden" name="order_payment_goods_nms"
									id="order_payment_goods_nms" value="JW 홀리풋볼 M (색상랜덤)" /> <input
									type="hidden" name="order_payment_goods_ids"
									id="order_payment_goods_ids" value="PI000003557" />
							</div>
						</section>
						<c:if test="${pTotalPrice >20000 }">
								...
								<div class="cpset">
									...
									<div class="dt">
										...
										<em class="prc"><b class="p"
											id="tot_goodsdlvr_cp_dc_amt_view">${item_fee }</b><i class="w">원</i></em> <span
											class="txt">할인적용</span> 
									</div>
								</div>
						...
						<section class="sect pont">
							...
							<div class="cdts" id="useGsPointDiv" style="display: none">
								<div class="ptset">
									<span class="input amt"><input type="text"
										id="useGsPoint" name="useGsPoint" value="0"
										...
										<div class="ddt">
											...
											<div data-ui-tab-ctn="tab_bils" data-ui-tab-val="tab_bils_1">
												<div class="cardinfo">
													<!--@@ 02.17 추가 -->
													<div class="select cd">
														<select id="order_payment_cardc"
															name="order_payment_cardc"
															onchange="selCard(this.value);">
															...
															<option value="12">NH농협카드</option>
															<option value="13">수협카드</option>
															<option value="15">우리카드</option>
															<option value="16">하나카드</option>
													...
													<div class="select nm">
														<select id="order_payment_halbu"
															name="order_payment_halbu"
							...
							<div class="cdts">
								<ul class="prcset">
									<li>
										...
										<div class="dd">
											<span class="prc"><em class="p">${pTotalPrice}</em><i class="w">원</i></span>
											<input type="hidden" id="order_payment_total_goods_amt"
												name="totGoodsAmt" value="${pTotalPrice}" />
										</div>
									</li>
									...
									<li id="couponDcLi">
										...
										<div class="dd">
											...
											<span class="prc dis"><em class="p"
												id="order_payment_total_dc_amt_view">${item_fee }</em><i class="w">원</i></span>
											<input type="hidden" id="order_payment_total_dc_amt"
												value="0" />
										</div>
									</li>
										</c:if>
									...
									<li>
										...
										<div class="dd">
											<span class="prc"><em class="p"
												id="order_payment_total_dlvr_amt_view">+${item_fee }</em><i class="w">원</i></span>
											<input type="hidden" id="gb_01_total_dlvr_amt" value="0" />
											<input type="hidden" id="gb_02_total_dlvr_amt" value="0" />
											<input type="hidden" id="order_payment_total_dlvr_amt"
												value="0" />
										</div>
									</li>
								</ul>
								<div class="tot">
									...
									<div class="dd">
										<span class="prc"><em class="p"
											id="order_payment_total_pay_amt_view"></em><i class="w">원</i></span>
										<input type="hidden" id="order_payment_total_pay_amt_ex_point"
								...
								var delv = ${item_fee};
								var totalPay = ${pTotalPrice +item_fee  }-cupon ;	
								$("#order_payment_total_pay_amt_view").text(totalPay);
								});
								
								
								$("#order_payment_gs_point_view").keyup(function(event) {
									var totalPay =$("#order_payment_total_pay_amt_view").text ;
									if (event.keycode == 13) {
										var	point = $("#order_payment_gs_point_view").text();
										totalPay = totalPay - point;
										$("#order_payment_total_pay_amt_view").val(totalPay);
										}
									});
								</script>
								<div class="gdpnt">
								...
								<input type="hidden" id="order_payment_total_save_amt" value="" />
							</div>
						</section>
							...
							<div class="cdts">
								...
								<ul class="agreeset">
									...
									<li><span class="checkbox"> <input type="checkbox"
											id="chk1" name="ordTerms" onclick="checkSelectAll()">
											<span class="txt"><em class="tt">주문할 상품의 상품명,
													상품가격, 배송정보를 확인하였으며, 구매에 동의하시겠습니까?(전자상거래법 제8조 제2항)</em></span>
									</span></li>
								</ul>
								<div class="bts">
									<a href="javascript:;" name="contentPopBtn"
										class="btn a lg btnBill" onclick="validNonMember();"> <span
										class="prc"><em class="p"
											id="order_payment_end_pay_amt_view">${pTotalPrice}</em><i class="w">원</i></span>
										<span class="txt">결제하기</span>
									</a>
								</div>
							</div>
						</section>
					...
					function validNonMember() {
						...
						var form = document.getElementById("order_payment_form");					
						form.action ='insertOrderList.do';
		...
		<article class="popLayer a popCardinput noClickClose"
			id="popCardinput"></article>
