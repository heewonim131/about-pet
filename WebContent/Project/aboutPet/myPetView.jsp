...
<div class="mypet-admin">
						...
						<div class="pc-tit">
							...
							<div class="right-item">
								<nav class="uidropmu dmenu">
									...
									<div class="list">
										<ul class="menu">
											<li><button type="button" class="bt" onclick="petUpdate();" data-content="" data-url="petUpdateView.do?petNo="${ petDTO.pet_code }>수정</button></li>
											<li><button type="button" class="bt" onclick="petDelete();" data-content="954216" data-url="petDelete.do?petNo="${ petDTO.pet_code }>삭제</button></li>
										</ul>
									</div>
								</nav>
							</div>
						...
						<div class="mypet-profile">
								...
								<div class="img-box">
									<div>
										<div class="my-picture medium1">
											<p class="picture"><img src="${ petDTO.pet_img }" alt="" style="height: 100%;width: 100%;"></p>
											<!-- <button class="btn edit"></button> -->
										</div>
										<p class="name">${ petDTO.pet_name }</p>
									</div>
								</div>
								<div class="t-box">
									<div class="item">
										...
										<div class="g-box">
											<ul>
												...
												<li>
													<p class="t1">알러지</p>
													<p class="t2">
														${ petDTO.alg }<span class="inr-t1"></span>
													</p>
												</li>
							...
							<div class="btnSet set1">
								<a href="#" onclick="myPetIncl(${ petDTO.pet_code });return false;" class="btn lg a" data-content="" data-url="myPetIncl(${ petDTO.pet_code });">건강수첩</a>
							</div>
						</div>
					</div>
				</div>
