...
<main class="container lnb page my" id="container">
							...
							<div class="pc-re-po01">
								<div class="oder-step ptb_memOrderbox">
									...
									<nav class="menushop re-po01">
										...
										<div class="list">
											<ul class="menu">
												<li class="active" ><a href="#" id="period_type_3" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=" class="bt" onclick="orderDeliveryList.setPeriod(3);return false;">최근 3개월</a></li>
												<li ><a href="#" id="period_type_6" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=6&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd="	class="bt" onclick="orderDeliveryList.setPeriod(6);return false;">최근 6개월</a></li>
												<li ><a href="#" id="period_type_9" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=9&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd="	class="bt" onclick="orderDeliveryList.setPeriod(9);return false;">최근 9개월</a></li>
												<li ><a href="#" id="period_type_12"data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=12&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=" class="bt" onclick="orderDeliveryList.setPeriod(12);return false;">최근 12개월</a></li>
												<li ><a href="#" id="period_type_0" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=0&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=" class="bt" onclick="orderDeliveryList.setPeriod(0);return false;">직접 입력</a></li>
											</ul>
										</div>
									</nav>
									...
									<div class="dummy-gray-line " style="margin-bottom:10px;">
										<div class="dummy-gray-line open">
											<div class="layout-date-picker noIcon">
												<span class="uiDate"><input type="text" value="2021.04.25" class="datepicker" title="날짜" id="delivery_start_dt" readonly="readonly" ></span>
												<span class="gap-area">-</span>
												<span class="uiDate"><input type="text" value="2021.07.24"  class="datepicker" title="날짜" id="delivery_end_dt" readonly="readonly"></span>
												<a href="#" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=" onclick="orderDeliveryList.search();return false;" class="btn lg">조회</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="inr-box piner">
							<div class="oder-step">
								<div class="step-list">
									<ul>
										<li id="stepOne">
											<a href="#" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=110" onclick="orderDeliveryList.searchStauts('110','stepOne');return false;"><p class="num">0</p></a>
											<p class="txt">입금대기</p>
										</li>
										<li id="stepTwo">
											<a href="#" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=120" onclick="orderDeliveryList.searchStauts('1230','stepTwo');return false;">$<p class="num">
											<c:if test="${ empty olist }">0</c:if>
											<c:if test="${ not empty olist }">1</c:if>
											</p></a>
											<p class="txt">결제완료</p>
										</li>
										<li id="stepThree">
											<a href="#" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=1340" onclick="orderDeliveryList.searchStauts('140','stepThree');return false;"><p class="num">0</p></a>
											<p class="txt">배송준비중</p>
										</li>
										<li id="stepFour">
											<a href="#" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=150" onclick="orderDeliveryList.searchStauts('150','stepFour');return false;"><p class="num">0</p></a>
											<p class="txt">배송중</p>
										</li>
										<li id="stepFive">
											<a href="#" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=160" onclick="orderDeliveryList.searchStauts('160','stepFive');return false;"><p class="num">0</p></a>
											<p class="txt">배송완료</p>
										</li>
										<li id="stepSix">
											<a href="#" data-content="951865" data-url="/mypage/order/indexDeliveryList?page=1&rows=20&period=3&ordAcptDtmStart=2021-04-25&ordAcptDtmEnd=2021-07-24&arrOrdDtlStatCd=170" onclick="orderDeliveryList.searchStauts('170','stepSix');return false;"><p class="num">0</p></a>
											<p class="txt">구매확정</p>
										</li>
									</ul>
								</div>
	...
	<input type="hidden" name="ordAcptDtmStart" value="2021-04-25" />
	<input type="hidden" name="ordAcptDtmEnd" value="2021-07-24" />
	<input type="hidden" id="callAjaxdeliveryHtml" name="callAjaxdeliveryHtml" value="N" />
	</form>
	
	<c:if test="${ empty olist }">
	<div class="statusDeliveryList" id="noDataDeliveryList" style="height: 428px;">
	...
	<c:if test="${ not empty olist }">
		...
		<div class="inr-box statusDeliveryList">
				<div class="item-list">
					<div class="top">
						<div class="tit">
							<p class="data"><fmt:formatDate value="${ order.ord_date }" pattern="yyyy.MM.dd"/></p>
							<a href="javascript:void(0);" class="detail-btn" data-content="${ order.ord_code }" data-url="orderDetail.do?ordNo=${ order.ord_code }" onclick="location.href='orderDetail.do?ordNo=${ order.ord_code }'">주문상세 </a>
						</div>
						<!-- 주문내역삭제 버튼 Flag eq Y -->
							<a href="javascript:void(0);" class="btn sm ord-del-btn" data-content="${ order.ord_code }" data-url="/mypage/order/orderDelete" onclick="orderDeliveryListBtn.goOrderDelete('${ order.ord_code }');return false;">
							<c:choose>
								<c:when test="${ (order.ord_status eq '결제완료') or (order.ord_status eq '배송준비중') }">전체주문취소</c:when>
				...
				<!-- 파랑 t3   결제완료 배송중 배송준비중   -->
							...
							<!-- 검정 기본 구매확정 배송완료 반품완료 CLM_DTL_STAT 260 반품거부 250 교환완료 450 교환거부 350  -->
							<!-- 회색 t2 주문취소 110 120 -->
							<!-- dvlrClass (배송 아이콘  :: 배송 처리 유형 코드 eq 택배배송 ? 'icon-t t2' : ((배송 처리 유형 코드 eq  당일배송)? 'icon-t' : ((배송 처리 유형 코드 eq  새벽배송)? 'icon-t t3' : ''))-->
							<div class="item-list">
									<div class="bottom">
										<div class="t-box">
											<p class="tit ">${ order.ord_status }</p>
											<p class="icon-t t2"> <!-- x 당일 / t2 택배 / t2 업체  -->
												${ order.dt_type }배송</p>
										</div>
					
										<div class="g-box dlvr-current-status">
										<p class="lt">
										<c:if test="${ (order.ord_status ne '배송완료') and (order.ord_status ne '구매확정') }">
											<c:choose>
												<c:when test="${ order.dt_type eq '당일' }"><fmt:formatDate value="${ order.ord_date }" pattern="MM월 dd일(E)"/> 도착 예정</c:when>
												<c:when test="${ order.dt_type eq '새벽' }"><fmt:formatDate value="${ order.ord_date }" pattern="MM월 dd일(E)"/> 도착 예정</c:when>
												<c:when test="${ order.dt_type eq '택배' }">배송 평균 1~2일 소요 예정</c:when>
												<c:when test="${ order.dt_type eq '업체' }">배송 평균 2~7일 소요 예정</c:when>
											</c:choose>
										</c:if>
										<c:if test="${ (order.ord_status eq '배송완료') or (order.ord_status eq '구매확정') }"><fmt:formatDate value="${ order.d_time }" pattern="MM월 dd일(E)"/> 배송 완료</c:if>
										</p>
										<c:if test="${ (order.dt_type eq '택배') and ( (order.ord_status eq '배송중') or (order.ord_status eq '배송완료') or (order.ord_status eq '구매확정') ) }">
													<a href="javascript:;" class="detail-btn" data-target="order" data-action="goodsflow" data-url="https://aboutpet.co.kr/mypage/order/goodsflow/599693" >배송조회</a></c:if>
													</div>
										...
										<div class="float-bx">
												...
												<c:choose>
													<c:when test="${ (order.ord_status eq '결제완료') or (order.ord_status eq '배송준비중') }">
															<div class="btnSet">
													...
													<c:when test="${ order.ord_status eq '주문취소' }">
															<div class="btnSet">
																<a href="javascript:void(0);" data-content="${ order.ord_code }" data-url="/mypage/order/indexClaimDetail?clmNo=${ order.ord_code }" 
													...
													<c:when test="${ (order.ord_status eq '배송중') or (order.ord_status eq '배송완료') }">
														<div class="btnSet">
		...
		<button class="btn-fixed-round t2" onclick="searchAllOrder();">전체주문보기</button><!-- 하단 gnb 있을 시 t2추가 --><!-- 주문/배송 목록 include -->
