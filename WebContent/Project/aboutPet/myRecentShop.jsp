			...
			<ul class="menu">
				<li class="open">
					...
					<ul class="sm">
						...
						<li class="active"><a class="bt" href="myRecentShop.do" data-url="myRecentShop.do" data-content="954216"><b class="t">최근 본 상품</b></a></li>
					</ul>
				</li>
				<li class="open">
...
<main class="container lnb page 1dep 2dep" id="container">
			<div class="inr" style="min-height: 398px;">
				<div class="contents" id="contents" style="min-height: 570px;">
						<!-- PC 타이틀 모바일에서 제거  -->
						<div class="pc-tit">
							<h2>최근 본 상품</h2>
						</div>
						...
						<section id="noneBoxPoint" class="no_data i5">
							<div class="inr">
								<div class="msg">
									최근 본 상품이 없습니다. <br> 다양한 반려동물 상품을 둘러보세요.</div>
								<div class="uimoreview">
									<a href="/shop/home" class="bt more">펫샵 바로가기</a>
								</div>
							</div>
						</section>
						</c:if>
						...
						<div class="lately-goods">
							...
							<c:forEach items="${ rslist }" var="rsDTO" varStatus="status">
							<c:if test="${ not flag }">
								<div class="item">
										<div class="pic">
											<a href="itemDetail.do?item_code=${ rsDTO.item_code }" data-content="${ rsDTO.item_code }" data-url="itemDetail.do?item_code=${ rsDTO.item_code }" class="pic">
												<img class="img" src="${ rsDTO.item_img }" onerror="this.src='https://aboutpet.co.kr/_images/mall/common/default_image.jpg'" alt="이미지">
												</a>
											<button type="button" class="bt zzim " data-content="${ rsDTO.item_code }" data-url="/goods/insertWish?goodsId=${ rsDTO.item_code }" data-goods-id="${ rsDTO.item_code }" data-target="goods" data-action="interest" data-yn="N">찜하기</button>
										</div>
										<div class="text-box">
											<p class="t1">
												<a href="itemDetail.do?item_code=${ rsDTO.item_code }" data-content="${ rsDTO.item_code }" data-url="itemDetail.do?item_code=${ rsDTO.item_code }" class="lk">${ rsDTO.item_name }</a>
											</p>
											<a href="itemDetail.do?item_code=${ rsDTO.item_code }" data-content="${ rsDTO.item_code }" data-url="itemDetail.do?item_code=${ rsDTO.item_code }" class="inf">
												<span class="prc"><em class="p"><fmt:formatNumber value="${rsDTO.item_price }"/></em><i class="w">원</i></span>
												<c:if test="${ rsDTO.sale_rate ne 0 }">
												<span class="pct"><em class="n">${ rsDTO.sale_rate }</em><i class="w">%</i></span>
												</c:if>
												</a>
											<a href="javascript:" onclick="fnDeleteGoodsRecent(this, '${ rsDTO.item_code }');" data-content="${ rsDTO.item_code }" data-url="/mypage/deleteRecentViewGoods" class="btn close">삭제</a>
										</div>
									</div>
