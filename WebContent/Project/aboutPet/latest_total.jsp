...
<!-- e : 검색 영역 -->
		...
		<!-- s : 본문영역 -->			
		<input type="hidden" id="totalCnt" value="1185"/>
		<input type="hidden" id="dispCornNo" value="567"/>
                        	...
                        	<li>
	                                <div class="thumb-box">
	                                    <div class="div-header" style="cursor:pointer;">
	                                        <div class="pic" onclick="srisDetail(86);"><img src="${litem.c_img}" alt=""></div>
	                                        <div class="tit" onclick="srisDetail(86);">${litem.s_name}<!-- 뇌색묘 뽀양이 &#39;나도 길냥이였어요&#39; --></div>
	                                    </div>
	                                    <div class="div-img"> 
	                                    	<a href="#" onclick="petTvDetail('N2021071303355', 0, 'N', 'PLY'); return false;" id="player_0" class="thumb-img" style="background-image:url(${litem.v_img});" data-content="N2021071303355" data-url="">
	                                    ...
	                                    <div class="thumb-info">
	                                        <div class="info">
	                                            ...
	                                            <div class="tlt k0426" id="petTvListTlt_0" onclick="petTvDetail('N2021071303355', 0, 'N', 'TTL');" data-content="N2021071303355;" data-url="">
	                                            	${litem.v_name}</div>
	                                            <div class="detail">
													<!--<span class="read play"> 5</span>-->
	                                                <span class="read like" id="like_0">${litem.v_like}</span>
	                                            </div>
	                                        </div>
	                                    </div>
	                                    </div>
